...
/// <summary>
/// Replacement details for an existing photo or video, as submitted by an admin.
/// </summary>
public sealed class GalleryMediaUpdateRequest
{
    /// <summary>
    ...
    /// <summary>
    /// Whether the media should be visible on the public site.
    /// </summary>
